...
function ApplicationRow({ a, onSaved }) {
  ...
  const save = async () => {
    setSaving(true);
    try {
      await api.patch(`/admin/applications/${a.application_id}`, form);
      ...
      <td className="p-4">
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="max-w-lg">
            <DialogHeader><DialogTitle className="font-heading text-navy">Manage application</DialogTitle></DialogHeader>
